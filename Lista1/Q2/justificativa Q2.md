...
O meu código inicial não retornava corretamente para todos os test cases, usei a IA Claude para tirar dúvidas, e a justificativa é que eu estava usando as variáveis no formato 'int (%d)' e estava sendo gerado um Overflow, a solução foi modificar o tipo das variáveis para 'long long (%lld)'
